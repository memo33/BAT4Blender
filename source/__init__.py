...
def register():
    ...
    bpy.utils.register_class(GUI_ops.B4BLODSlice)
    bpy.utils.register_class(GUI_ops.B4BCamSetup)
...
def unregister():
    ...
    bpy.utils.unregister_class(GUI_ops.B4BLODSlice)
    bpy.utils.unregister_class(GUI_ops.B4BCamSetup)
